...
detectorFace = cv2.CascadeClassifier('haarcascade\haarcascade-frontalface-default.xml') #Reconhece a face

reconhecedor = cv2.face.FisherFaceRecognizer_create() #Carrega o método Fisherface
reconhecedor.read('classificadores\classificadorFisherYaleSemParametro.yml') #Leitura do arquivo do treinamento
...
print('---Resultado da Avalicação Algoritmo Fisherface sem Paramento---')
