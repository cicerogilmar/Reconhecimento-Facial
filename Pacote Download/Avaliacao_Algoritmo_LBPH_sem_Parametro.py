...
reconhecedor.read('classificadores\classificadorLBPHYaleSemParametro.yml') #Leitura do arquivo do treinamento
...
print('---Resultado da Avalicação Algoritmo LBPH sem Paramento---')
