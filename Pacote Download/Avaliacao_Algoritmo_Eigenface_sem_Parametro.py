...
reconhecedor.read('classificadores\classificadorEigenYaleSemParametro.yml')  # Leitura do arquivo do treinamento
...
print('---Resultado da Avalicação Algoritmo Eigenface sem Paramento---')
