...
reconhecedor.read('classificadores\classificadorFisherYaleComParametro.yml') #Leitura do arquivo do treinamento
...
print('---Resultado da Avalicação Algoritmo Fisherface com Paramento---')
